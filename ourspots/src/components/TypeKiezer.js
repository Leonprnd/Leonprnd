...
export default function TypeKiezer({ gekozen, opKiezen }) {
  ...
  return (
    <View>
      <Text style={stijl.kopje}>{t.moment.mijlpalenKop}</Text>
      <ScrollView
        horizontal
      ...
      <Text style={[stijl.kopje, { marginTop: ruimte.l }]}>{t.moment.gewoonKop}</Text>
...
function GrooteTegel({ type, woorden, actief, opKiezen }) {
  return (
    <Pressable
      onPress={opKiezen}
      style={({ pressed }) => [
...
function KleineTegel({ type, woorden, actief, opKiezen }) {
  return (
    <Pressable
      onPress={opKiezen}
      style={({ pressed }) => [
