...
export default function Welkom() {
  const { profiel, bewaarProfiel } = useApp();
    ...
    >
      ...
      >
        <View style={stijl.kop}>
          ...
          <Titel style={{ textAlign: 'center' }}>Hoi! Wie ben jij?</Titel>
          <Lopend zacht style={{ textAlign: 'center', marginTop: 6 }}>
            Je liefje ziet straks deze naam en dit icoontje op jullie kaart.
          </Lopend>
        </View>
        ...
        <Text style={stijl.kopje}>Kies je icoontje</Text>
        ...
        <Text style={[stijl.kopje, { marginTop: ruimte.xl }]}>En je kleur</Text>
        <View style={stijl.raster}>
